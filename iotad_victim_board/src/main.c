...
#define PIN_USART3_RX_Source GPIO_PinSource10
#define PIN_USART3_TX_Source GPIO_PinSource11
#define PORT_USART3 GPIOB
...
*/
  ...
  GPIO_InitStructure.GPIO_Pin =  PIN_USART3_TX| PIN_USART3_RX;
  ...
  GPIO_PinAFConfig(PORT_USART3,PIN_USART3_RX_Source,GPIO_AF_USART3 );
  GPIO_PinAFConfig(PORT_USART3,PIN_USART3_TX_Source,GPIO_AF_USART3 );
  GPIO_Init(PORT_USART3, &GPIO_InitStructure);
  ...
  while(1)
    {
      ...
      /*
    // Check if the u USART_SendData user button is pressed 
